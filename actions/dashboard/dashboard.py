...
debug_dialog = (r"""
  ...
  (function(){
    ...
    function pollConnect(){
      ...
      // Watch the run's real state so this is never opaque: end a dead session,
      // show a queued state when blocked behind another session, else the live step.
